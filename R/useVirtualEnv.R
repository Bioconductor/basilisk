...
#' 
#' @return 
#' \code{setupVirtualEnv} will create a virtual environment in the installation directory of \code{pkgname} if specified, or at the default location for virtual environments otherwise.
#' It returns a \code{NULL} value, invisibly.
#'
