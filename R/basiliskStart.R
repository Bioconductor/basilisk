...
#' @param proc A cluster object pointing to an active R process, usually generated by \code{basiliskStart}.
...
#' @param fun A function to be executed in the separate R process.
...
basiliskRun <- function(proc=NULL, fun, ..., evname, pkgname=NULL, fork=TRUE) {
    if (is.null(proc)) {
        proc <- basiliskStart(envname, pkgname=pkgname, fork=fork)
