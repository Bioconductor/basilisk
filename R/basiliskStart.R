...
#' 
#' Alternatively, \code{NULL} to indicate that the base conda installation should be used.
...
#'
#' Both the base conda installation and the environments will be placed in an external user-writable directory,
