### intent of these functions is to consolidate the selections
### of versions of python packages for testing behavior of 
### basilisk client package requests from pip or conda
### note that conda version specs have 'p=v' but pip have 'p==v'
