...
In the rest of this section, we will discuss the `r Biocpkg("basilisk")`-specific parts of R/Bioconductor package development. 
...
Setting the `BASILISK_EXTERNAL_DIR` environment variable will change where the Anaconda installation and environments are placed.
This is usually unnecessary unless the default path generated by `r CRANpkg("rappdirs")` contains spaces;
or the combination of the default path and Anaconda's directory structure exceeds the 260 character limit on Windows.
